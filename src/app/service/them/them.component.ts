...
export class ThemComponent implements OnChanges {
  ...
  save() {
    this.themCertificateVersion.Licence_Service_ID = this.licenceData.Licence_Service_ID;
    this.themCertificateVersion.Application_No = this.licenceData.Application_No;
    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        this.themService.save(this.themCertificateVersion).subscribe(deptSuspension => {
          ...
          this.themform = false;
          const index: number = this.themCertificateVersionList.indexOf(this.themCertificateVersion);
          if (index !== -1) {
