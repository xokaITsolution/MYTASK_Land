...
export class MeasurmentComponent implements OnChanges {
  ...
  getmeasurment(propertyid) {
    this.measurmentService.getAll(propertyid).subscribe(
  ...
  save() {
    this.measurmentService.save(this.measurment).subscribe(
      (deptSuspension) => {
  ...
  add() {
    ...
    this.measurmentService.Add(this.measurment).subscribe(
      (message) => {
  ...
  Delete() {
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        this.measurmentService.Delete(this.measurment.Measurement).subscribe(
          (deptSuspension) => {
            console.log("deptSuspension", deptSuspension);
            const toast = this.notificationsService.success(
              "Sucess",
